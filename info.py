...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "movies4uhd") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002485029394').split()]
